package com.example.demo.chuanglan;
 ...
 * 免密登录：token置换手机号demo
 **/
public class TokenExchangeMobileDemo {
    // 移动telcome枚举值
        ...
        try {
            ...
            if (null != jsonObject) {
                ...
                if ("200000".equals(code)) {
                    ...
                    System.out.println("mobile:" + DES.decryptDES(mobile, "XXXXXX")); //手机号DES解密，解密秘钥为appId对应的appKey
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
